        ...
        <div class="content-wrapper">
            ...
            <div class="border border-blue-100 rounded-lg p-3">
                <div class="mb-3">
                    ...
                    <input type="text" name="name" id="name" class="w-full border border-gray-300 rounded-lg p-2" placeholder="Nhập tên thương hiệu" value="{{ old('name') }}" oninput="generateSlug()">
                    @error('name')
