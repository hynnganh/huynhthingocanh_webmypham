        ...
        <div class="content-wrapper">
            <div class="border border-blue-100 mb-3 rounded-lg p-2">
                <div class="flex items-center justify-between">
                    <h2 class="text-xl font-bold text-blue-600">CẬP NHẬP DANH MỤC</h2>
                ...
                <div class="flex gap-6">
                    <div class="basis-2/3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="w-full border border-gray-300 rounded-lg p-2" placeholder="Tên sản phẩm" name="name" id="name" value="{{ old('name', $category->name) }}">
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" class="w-full border border-gray-300 rounded-lg p-2">{{ old('description',$category->description) }}</textarea>
                        </div>
