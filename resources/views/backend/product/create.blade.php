                ...
                <div class="flex gap-6">
                    <div class="basis-2/3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="w-full border border-gray-300 rounded-lg p-2" placeholder="Tên sản phẩm" name="name" id="name" value="{{ old('name') }}">
                            @error('name')
                        ...
                        <div class="flex justify-between gap-5">
                            <div class="mb-3 w-1/3">
                                ...
                                <input type="number" class="w-full border border-gray-300 rounded-lg p-2" placeholder="Giá gốc" name="price_root" id="price_root" value="{{ old('price_root') }}">
                                @error('price_root')
                                    <div class="text-red-500">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3 w-1/3">
                                ...
                                <input type="number" class="w-full border border-gray-300 rounded-lg p-2" placeholder="Giá khuyến mãi" name="price_sale" id="price_sale" value="{{ old('price_sale') }}">
                                @error('price_sale')
                                    <div class="text-red-500">{{ $message }}</div>
                                @enderror
                            </div>
