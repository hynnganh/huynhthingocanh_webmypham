<x-layout-admin>
    <form action="{{ route('post.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow">
        @csrf

        <h2 class="text-xl font-bold mb-4 text-blue-600">Thêm Bài Viết</h2>
        ...
        <div class="mb-4">
            ...
            <textarea name="description" id="description"
                      class="w-full border border-gray-300 rounded-lg p-2" rows="3">{{ old('description') }}</textarea>
        </div>
        ...
        <div class="mb-4">
            ...
            <textarea name="detail" id="detail"
                      class="w-full border border-gray-300 rounded-lg p-2" rows="5">{{ old('detail') }}</textarea>
        </div>
        ...
        <div class="flex justify-between mt-6">
            ...
            <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700">Thêm mới</button>
        </div>
    </form>
</x-layout-admin>
